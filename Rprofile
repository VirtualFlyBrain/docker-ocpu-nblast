...
if (!require("nat")) devtools::install_github("jefferis/nat", force=TRUE, dependencies=TRUE, lib="/usr/local/lib/R/site-library")
if (!require("vfbr")) devtools::install_github("jefferis/vfbr", force=TRUE, dependencies=TRUE, lib="/usr/local/lib/R/site-library")
if (!require("flycircuit")) devtools::install_github("jefferis/flycircuit", force=TRUE, dependencies=TRUE, lib="/usr/local/lib/R/site-library")
if (!require("flynblastscores")) devtools::install_github("jefferis/flynblastscores", force=TRUE, dependencies=TRUE, lib="/usr/local/lib/R/site-library")
