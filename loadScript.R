...
devtools::install_github("jefferis/nat", dependencies=TRUE, lib="/usr/local/lib/R/site-library", force = TRUE)
devtools::install_github("jefferis/vfbr", dependencies=TRUE, lib="/usr/local/lib/R/site-library", force = TRUE)
devtools::install_github("jefferis/flycircuit", dependencies=TRUE, lib="/usr/local/lib/R/site-library", force = TRUE)
devtools::install_github("jefferis/flynblastscores", dependencies=TRUE, lib="/usr/local/lib/R/site-library", force = TRUE)
