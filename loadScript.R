...
install.packages("rgl", repos="https://cloud.r-project.org/", dependencies = TRUE, rgl.useNULL = TRUE)
devtools::install_github("jefferis/nat", dependencies=TRUE, rgl.useNULL = TRUE)
devtools::install_github("jefferis/flycircuit", dependencies=TRUE, rgl.useNULL = TRUE)
devtools::install_github("jefferis/flynblastscores", dependencies=TRUE, rgl.useNULL = TRUE)
devtools::install_github("jefferis/vfbr", dependencies=TRUE, rgl.useNULL = TRUE)
